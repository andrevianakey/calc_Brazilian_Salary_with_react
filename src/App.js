...
const COLOR_INSS = '#e67f22';
const COLOR_IRPF = '#e62227';
const COLOR_NET_SALARY = '#22e67f';
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="center">Cálculo de salário utilizando React</h1>
        ...
        />
        <h6 className="center"> Calcule seu salário líquido, bem como os descontos de INSS e IRF utilizando React!!</h6>
